...
class Box {
  constructor(x, y) {
    this.x = x;
    this.y = y;
    this.player1img = loadImage(
      "assets/—Pngtree—apple red fruit commercial element_4037323.png"
    );
    this.player2img = loadImage(
      "assets/—Pngtree—summer fruit cartoon banana_3979229.png"
    );
